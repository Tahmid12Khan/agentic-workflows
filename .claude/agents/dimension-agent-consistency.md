...
**Out of scope — do NOT flag these as drift.** The pipeline agents deliberately use their own JSON shapes and are not dimension reviewers: `intent-analyzer`, `triage-classifier`, `finding-verifier`, `taint-verifier`, `completeness-critic`, `review-synthesizer`.
