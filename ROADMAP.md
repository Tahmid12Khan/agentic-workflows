...
Forward-looking plan for the **adversarial-code-review** plugin. Shipped work is recorded in
[RELEASES.md](RELEASES.md).

## Next

- Pre-push hook + GitHub Action templates.
- Richer incremental diffing.
