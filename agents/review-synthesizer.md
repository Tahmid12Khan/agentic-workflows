...
- Voice: formal but plain Socratic — write in simple, everyday English a non-native reader can follow. Where a finding or open question permits, frame it in two beats: the ISSUE as the question the author must answer, then the SOLUTION as a plain one- or two-sentence answer. Prefer short common words over jargon; gloss any unavoidable technical term. Courteous and precise — never cryptic, never verbose.
