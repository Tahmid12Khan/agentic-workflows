...
const { plan, bundle, diffPath, contextPackPath, diffIndex, historyPath, testSignal, shards, routing, flags, startedAt, prNumber, checkout, diffRanges, sliceDir, doctrinePaths, contextPackStats, knownFalsePositives, allManifest, allParts, buildNotes } = A;
