...
export function buildArgs({ plan, bundle, diffPath, contextPackPath, contextPackStats, diffIndex, diffRanges, sliceDir, doctrineText, scrutiny, checks, meta, historyPath, testSignal, knownFalsePositives, shards, allManifest, allParts, buildNotes }) {
  const m = meta ?? {};
