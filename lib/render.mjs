...
export function renderReport({ findings, criteria, tier, needsHuman, skipped, strengths, summary, context, verify, learnings, coverage, meta, checkout = null }) {
...
export function renderHtml(data) {
  const { findings = [], criteria = [], tier = 'standard', needsHuman = [], skipped = [], strengths = [], summary = '', context = {}, verify = {}, coverage = null, meta = null, checkout = null, gate = { block_on: ['critical'], warn_on: ['high'] } } = data;
