...
export function renderHtml(data) {
  ...
  // Token usage + USD cost of this review run, top-left of the header. Omitted
  // entirely when no usage was captured (usage.mjs returns null) so the report is
  // unchanged for runs without transcript access.
...
.usage{display:inline-block;float:left;margin:0 22px 14px 0;padding:11px 14px;border:1px solid var(--line);border-radius:9px;background:var(--panel);font-family:var(--mono);font-size:12.5px;min-width:172px}
.usage .u-row{display:flex;justify-content:space-between;gap:18px;padding:2px 0}
.usage .u-k{color:var(--muted);text-transform:uppercase;letter-spacing:.05em}
.usage .u-v{color:var(--text)}
.usage .u-cost{margin-top:5px;padding-top:6px;border-top:1px solid var(--line)}
