...
export function renderReport({ findings, criteria, tier, needsHuman, skipped, strengths, summary, summaryPoints, context, verify, learnings, coverage, meta, checkout = null, usage = null }) {
...
export function renderHtml(data) {
  const { findings = [], criteria = [], tier = 'standard', needsHuman = [], skipped = [], strengths = [], summary = '', summaryPoints = [], context = {}, verify = {}, coverage = null, meta = null, checkout = null, usage = null, gate = { block_on: ['critical'], warn_on: ['high'] } } = data;
