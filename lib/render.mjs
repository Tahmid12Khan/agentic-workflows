...
function pipelineRows(plan) {
  ...
  // cheap x1 haiku screen (every workflow tier: low/standard/high) — never both. Reflect whichever.
  ...
  return [
    ...
    mk('completeness-critic', critic ? 'opus' : 'haiku', 'false-negative guard', critic || screen,
      critic ? 'exhaustive completeness sweep (opus, with the diff)' : screen ? 'x1 haiku coverage-gap screen (no diff)' : 'skipped — trivial change reviewed inline'),
