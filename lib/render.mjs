...
function pipelineRows(plan) {
  ...
  return [
    ...
    mk('intent-harvester', 'sonnet', 'stated vs derived intent + primary vs extra grouping', !trivial, trivial ? 'skipped — a trivial change is reviewed inline' : 'built the acceptance-criteria model and grouped primary vs extra intents'),
...
export function renderReport({ findings, criteria, tier, needsHuman, skipped, strengths, summary, summaryPoints, context, verify, learnings, coverage, meta, checkout = null, usage = null, outOfDiff = [] }) {
...
export function renderHtml(data) {
  const { findings = [], criteria = [], tier = 'standard', needsHuman = [], skipped = [], strengths = [], summary = '', summaryPoints = [], context = {}, verify = {}, coverage = null, meta = null, checkout = null, usage = null, outOfDiff = [], gate = { block_on: ['critical'], warn_on: ['high'] } } = data;
