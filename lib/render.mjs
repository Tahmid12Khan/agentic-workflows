...
export function renderReport({ findings, criteria, tier, needsHuman, skipped, strengths, summary, context, verify, learnings, coverage, meta }) {
...
export function renderHtml(data) {
  const { findings = [], criteria = [], tier = 'standard', needsHuman = [], skipped = [], strengths = [], summary = '', context = {}, verify = {}, coverage = null, meta = null, gate = { block_on: ['critical'], warn_on: ['high'] } } = data;
