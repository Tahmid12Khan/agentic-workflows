...
import { renderReport, renderVerdict, renderHtml } from './render.mjs';
...
const md = renderReport({ findings, criteria, tier, needsHuman, skipped, strengths, summary, context, verify, learnings: { applied: learningNote } });
writeFileSync(outPath, md);

const html = renderHtml({ findings, criteria, tier, gate, needsHuman, skipped, strengths, summary, context, verify });
