...
Runs the unit suite (triage, render, shard, verify, memory, scan, comments, gather, route, checkout, context-pack) **and** the CLI integration suite (`tests/cli.test.mjs` — spawns plan/verify/scan/report/memory/route/comments/preflight/context-pack end-to-end). No build, no dependencies.
